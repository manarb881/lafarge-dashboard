...
#define ARROW_CXX_COMPILER_FLAGS "-ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -stdlib=libc++ -fvisibility-inlines-hidden -fmessage-length=0 -isystem /opt/anaconda3/include -fdebug-prefix-map=/var/folders/k1/30mswbxs7r1g6zwn8y4fyt500000gp/T/abs_12800ilod2/croot/arrow-cpp_1707253275500/work=/usr/local/src/conda/arrow-cpp-14.0.2 -fdebug-prefix-map=/opt/anaconda3=/usr/local/src/conda-prefix -Qunused-arguments -fcolor-diagnostics"
